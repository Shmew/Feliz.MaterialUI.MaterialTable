# Feliz.MaterialUI.MaterialTable - Remote Data

Taken from [material-table - Remote Data](https://material-table.com/#/docs/features/remote-data)

```fsharp:materialtable-remotedata

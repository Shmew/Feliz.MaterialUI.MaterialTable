# Feliz.MaterialUI.MaterialTable - Fixed Columns

Taken from [material-table - Fixed Columns](https://material-table.com/#/docs/features/fixed-columns)

```fsharp:materialtable-fixedcolumns

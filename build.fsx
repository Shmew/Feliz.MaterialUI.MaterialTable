...
let project = "Feliz.MaterialUI.MaterialTable"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Fable bindings written in the Feliz-style for material-table"

// Author(s) of the project
let author = "Cody Johnson"

// File system information
let solutionFile = "Feliz.MaterialUI.MaterialTable.sln"

// Github repo
let repo = "https://github.com/Shmew/Feliz.MaterialUI.MaterialTable"
...
Target.create "CopyDocFiles" <| fun _ ->
    [ pub @@ "MaterialTable/README.md", __SOURCE_DIRECTORY__ @@ "README.md"
      pub @@ "MaterialTable/RELEASE_NOTES.md", __SOURCE_DIRECTORY__ @@ "RELEASE_NOTES.md"
...
Target.create "PackageJson" <| fun _ ->
    let setValues (current: Json.JsonPackage) =
        { current with
            ...
            Bugs = 
                { Json.BugsValue.Url = 
                    @"https://github.com/Shmew/Feliz.MaterialUI.MaterialTable/issues/new/choose" |> Some } |> Some
            License = "MIT" |> Some
            Author = author |> Some
            Private = true |> Some }
